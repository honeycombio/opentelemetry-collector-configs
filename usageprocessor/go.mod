...
require (
	github.com/honeycombio/opentelemetry-collector-configs/honeycombextension v0.1.0
...
replace github.com/honeycombio/opentelemetry-collector-configs/honeycombextension => ../honeycombextension
