module github.com/honeycombio/opentelemetry-collector-configs/honeycombextension
...
replace github.com/honeycombio/opentelemetry-collector-configs/usageprocessor => ../usageprocessor
